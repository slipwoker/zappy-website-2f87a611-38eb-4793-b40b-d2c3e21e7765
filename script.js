document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getOrCreateError(field) {
      ...
      let errorEl = fieldWrapper.querySelector('.form-error');
      if (!errorEl) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isFormValid) {
        ...
        if (firstInvalid) {
          firstInvalid.focus();
          const navbarEl = document.querySelector('.navbar, nav, header');
          const offset = navbarEl ? navbarEl.offsetHeight + 20 : 20;
          const fieldTop =
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יוצרים מתוק משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2f87a611-38eb-4793-b40b-d2c3e21e7765',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2f87a611-38eb-4793-b40b-d2c3e21e7765';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2f87a611-38eb-4793-b40b-d2c3e21e7765';
